...
const stats = [
  { label: "Focus sessions today", value: "3", icon: Focus },
  { label: "Tasks completed", value: "7", icon: ListChecks },
  { label: "Streak", value: "5 days", icon: TrendingUp },
];
    ...
    <div className="p-6 md:p-10 max-w-5xl mx-auto space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-xl">
          Your cognitive companion is ready. What would you like to focus on today?
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {features.map(({ to, icon: Icon, label, desc, gradient }, i) => (
          ...
          >
            <Link
              to={to}
              className={`block ${gradient} rounded-2xl p-6 hover:shadow-md transition-shadow group`}
            >
